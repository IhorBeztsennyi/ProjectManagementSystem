...
@WebServlet(urlPatterns = "/allJavaDevelopers")
public class AllJavaDevelopersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<DevelopersDto> developers = queries.getJavaDevelopers().stream()
                .map(developersConverter::daoToDto)
                .collect(Collectors.toList());
        req.setAttribute("developers", developers);
        req.getRequestDispatcher("/WEB-INF/html/allJavaDevelopers.jsp").forward(req, resp);
    }
}

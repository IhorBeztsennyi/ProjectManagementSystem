...
@WebServlet(urlPatterns = "/allMiddleDevelopers")
public class AllMiddleDevelopersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<DevelopersDto> developers = queries.getMiddleDevelopers().stream()
                .map(developersConverter::daoToDto)
                .collect(Collectors.toList());
        req.setAttribute("developers", developers);
        req.getRequestDispatcher("/WEB-INF/html/allMiddleDevelopers.jsp").forward(req, resp);
    }
}

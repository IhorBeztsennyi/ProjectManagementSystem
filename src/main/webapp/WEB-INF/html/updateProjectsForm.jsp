    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="form-group">
                     <label for="project_id">ID:</label><br>
                     <input type="text" class="form-control" id="project_id" placeholder="ID" name="project_id"><br>
            </div>
                <div class="form-group">
                      <label for="name">Name:</label><br>
                      <input type="text" class="form-control" id="name" placeholder="Enter new name" name="name"><br>
                </div>
                <div class="form-group">
